...
public class Scroller extends JScrollPane{
	...
	public Scroller(){
		...
		//verticalsetBackground(Color.BLACK);
	...
	//part of the below code was taken from https://stackoverflow.com/questions/16373459/java-jscrollbar-design/16375805#16375805
	private static class ModernScrollBarUI extends BasicScrollBarUI {

			 private JScrollPane sp;

			 public ModernScrollBarUI(Scroller sp) {
					 this.sp = sp;
			 }
    ...
    public Scroller(int vsbPolicy, int hsbPolicy) {
        this(null, vsbPolicy, hsbPolicy);
    }

    public Scroller(Component view, int vsbPolicy, int hsbPolicy) {
